...
\draw[dotted] (5.0,0) -- (5.0,2.5);
\draw[dotted] (0,2.5) -- (3.0,2.5);
%\draw[dotted] (6.5,0) -- (6.5,2.5);
%\draw[dotted] (2.5,2.5) -- (6.5,2.5);
%for voltage
\draw[dotted] (0,3.4) -- (4.5,3.4);
\draw[dotted] (4.0,0) -- (4.0,3.4);
%for current edges
\draw[dotted] (0,3.0) -- (4,3.0);
\draw[dotted] (0,2.0) -- (5,2.0);

% temperature
\draw[thick] (0,0.2) -- (0.5,0.2) -- (2.0,2.5) -- (4,2.5) -- (5.0,0.2) -- (7,0.2);
% voltage
...
\draw [<-] ($(sg) - (0.85, 0)$) -- ($(sg) + (0.1, 0)$);
\draw (sg) node (sg) at +(0.5, 0mm) {$V(t)$};

\draw [<-] ($(sg) - (2.2, 0.4)$) -- ($(sg) - (0.25, 0.4)$);
\draw (sg) node (sg) at +(0.1, -0.4) {$i(t)$};

\draw [<-] ($(sg) - (2.3, 0.4)$) -- ($(sg) - (0.35, 0.4)$);
\draw (sg) node (sg) at +(0.0, -0.4) {$T(t)$};
